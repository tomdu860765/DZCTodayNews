//
//  DZCPhotosTableViewController.m
//  DZCTodayNews
//
...
#import "DZCPhotosTableViewController.h"
...
@interface DZCPhotosTableViewController ()
@property(nonatomic,strong)NSMutableArray *MainVCarray;
@end

@implementation DZCPhotosTableViewController
