//
//  DZCFinanceTableViewController.m
//  DZCTodayNews
//
...
#import "DZCFinanceTableViewController.h"
...
@interface DZCFinanceTableViewController ()
@property(nonatomic,strong)NSMutableArray *MainVCarray;
@end

@implementation DZCFinanceTableViewController
